...
keymap.set("x", "<c-k>", '<cmd>call utils#MoveSelection("up")<cr>', { desc = "move selection up" })

keymap.set("x", "<c-j>", '<cmd>call utils#MoveSelection("down")<cr>', { desc = "move selection down" })
