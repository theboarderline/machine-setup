require('go').setup({
  ...
  goimports='gopls', -- goimports command, can be gopls[default] or either goimport or golines if need to split long lines
  ...
  test_runner = 'ginkgo', -- one of {`go`, `richgo`, `dlv`, `ginkgo`, `gotestsum`}
